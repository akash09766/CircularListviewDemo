...
/**
 * Created by Akash Wangalwar on 01-11-2016.
 */
public class CircularSeekBar extends View {
    ...
    private static final float DEFAULT_START_ANGLE = -90f; // Geometric (clockwise, relative to 3 o'clock)
    ...
    //	private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.parseColor("#5bbbcf");
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.TRANSPARENT;
    ...
    public void setStartAndAngle(float startAngle,float endAngle) {
